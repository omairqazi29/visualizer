...
# EB-1 visa category codes used for non-India usage subtraction in freeze mode.
_EB1_CATEGORIES = ['E11', 'E12', 'E13', 'E1', 'IB1', 'IB2']
...
class FreezePolicy:
    ...
    def adjust_india_eb1_supply(
        ...
        non_india_eb1_usage = dos_df[
            ...
            & (dos_df['visa_category'].isin(_EB1_CATEGORIES))
        ]['count'].sum()
...
class RealRestrictionsPolicy:
    ...
    def adjust_india_eb1_supply(
        ...
        return base_india_supply + eb45_savings + int(fb_savings * EB1_STATUTORY_SHARE)

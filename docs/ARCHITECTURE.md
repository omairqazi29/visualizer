...
- Current reality (Jul 2026 VB): India EB-1 FAD **retrogressed further** to 15OCT22 (from 15DEC22 in Jun). EB-2 India now **Unavailable** for remainder of FY2026. DOS warns further EB-1 retrogression or "U" possible Aug/Sep 2026. FY2024 Visa Office: "~6,952 were issued to applicants chargeable to India" (out of 47,462 EB-1 total). USCIS Apr 2026 inv: 20,850 India EB-1 I-485 pending (down from 22,310 in Mar — approvals outpacing new filings). I-140 pipeline: shadow ratio ~3.47x. VB history CSV and parser updated to handle "U" (Unavailable) status. No INA 201/203 amendments.
